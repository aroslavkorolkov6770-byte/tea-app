...
const INITIAL_TEA_DATABASE: Tea[] = [
  { id: 1, name: "Лунцзин", type: "Зеленый", category: "Зеленый чай", strength: "Мягкий", info: "75°C", summary: "Ореховый профиль.", desc: "Классика из Ханчжоу.", img: "https://images.unsplash.com/photo-1627435601361-ec25f5b1d0e5?q=80&w=800" }
];
...
export default function Home() {
  ...
  useEffect(() => {
    const fetchDayTea = async () => {
      ...
      } catch (err) { setDayTea(INITIAL_TEA_DATABASE[0]); }
    };
    fetchDayTea();
  }, []);
