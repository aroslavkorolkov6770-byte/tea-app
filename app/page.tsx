  ...
  return (
    <div style={{ backgroundColor: '#0d0f0d', minHeight: '100vh', color: '#e0e0e0', position: 'relative', overflowX: 'hidden' }}>
      ...
      <main style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '150px' }}>
        ...
        {/* 2. СЕКЦИЯ: ФИЛОСОФИЯ (НЕЙРО-ТЕКСТ) */}
        ...
        <section style={{ padding: '0 20px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '60px' }}>
          {/* Фото 1 - Большое вертикальное */}
          <div style={{ ...galleryItem, gridRow: 'span 2', backgroundImage: 'url("https://images.unsplash.com/photo-1556679343-c7306c1976bc?q=80&w=600")' }}></div>
          {/* Фото 2 - Горизонтальное */}
          <div style={{ ...galleryItem, height: '180px', backgroundImage: 'url("https://images.unsplash.com/photo-1594631252845-29fc4586d517?q=80&w=600")' }}></div>
          {/* Фото 3 - Квадратное */}
          <div style={{ ...galleryItem, height: '180px', backgroundImage: 'url("https://images.unsplash.com/photo-1571934811356-5cc561b6821f?q=80&w=600")' }}></div>
          {/* Фото 4 - Широкое на 2 колонки */}
          <div style={{ ...galleryItem, gridColumn: 'span 2', height: '220px', backgroundImage: 'url("https://images.unsplash.com/photo-1550989460-0adf9ea622e2?q=80&w=1000")' }}></div>
        </section>

        {/* 4. СЕКЦИЯ: ТЕКСТ О МАСТЕРСТВЕ */}
