...
const INITIAL_ASSORTMENT = [
            ...
            children: [
              {
                ...
                children: [
                  ...
                  { id: "as_c2", title: "Жёлтый чай", content: "Проходит процесс «томления». Вкус округлый, бархатистый." },
                  { id: "as_c3", title: "Зелёный чай", content: "Остановка ферментации фиксацией зелени. Свежий, травянистый профиль." },
                  { id: "as_c4", title: "Зелёный жасминовый", content: "Зеленый чай, ароматизированный живыми цветами жасмина." },
                  ...
                  { id: "as_c7", title: "Пуэр шу (тёмный)", content: "Прошел форсированную постферментацию (влажное скирдование). Плотный древесно-землистый вкус." },
                  { id: "as_c8", title: "Пуэр шэн (зелёный)", content: "Естественная ферментация. Вкус меняется с возрастом от дерзкого к глубокому." },
                  { id: "as_c9", title: "Связанный чай", content: "Листья зеленого чая, связанные вручную вокруг цветка. Красиво раскрывается при заваривании." }
                ]
              },
              {
                id: "as_1_1_1_in", title: "Индия",
                children: [
                  { id: "as_i1", title: "Дарджилинг", content: "Высокогорный индийский чай с легким мускатным вкусом и цветочным ароматом." },
                  { id: "as_i2", title: "Ассам", content: "Классический крепкий индийский чай с солодовыми нотами." },
                  { id: "as_i3", title: "Прочие регионы", content: "Чаи из Нилгири и других штатов Индии." }
                ]
              },
              { id: "as_c_cey", title: "Цейлон (Шри-Ланка)", content: "Классический черный чай с медно-красным настоем и приятной терпкостью." },
              { id: "as_c_oth", title: "Прочие страны", content: "Чаи из Японии (Матча, Сенча), Вьетнам, Кения, Грузия, Краснодарский край и др." }
            ]
          },
          {
            ...
            children: [
              {
                id: "as_add_1", title: "С ароматизаторами",
                children: [
                  { id: "as_a1", title: "На основе чёрного чая", content: "Купаж на основе черного чая с добавлением ароматизаторов и кусочков ягод/фруктов." },
                  { id: "as_a2", title: "На основе зелёного чая", content: "Купаж на основе зеленого чая с добавлением ароматизаторов." },
                  { id: "as_a3", title: "На основе улуна", content: "Ароматизированные улуны (например, молочный улун с добавками)." },
                  { id: "as_a4", title: "На основе пуэра", content: "Пуэры с добавлением вишни, земляники или других ароматов." },
                  { id: "as_a5", title: "На основе купажей", content: "Смеси черного и зеленого чая с ароматизаторами (например, «1001 ночь»)." }
                ]
              },
              { id: "as_add_2", title: "С натуральными добавками (без ароматизаторов)", content: "Чистые чайные купажи с сухими кусочками ягод, фруктов, специй и трав без химического вмешательства." }
            ]
          }
        ]
      },
      {
        id: "as_1_2", title: "1.2 Прессованный чай",
        desc: "Формы прессовки: сяо то, то ча, бин ча (блин), фан ча, чжуан ча (кирпич) и другие.",
        children: [
          { id: "as_p_1", title: "Белый прессованный", content: "Белый чай (например, Бай Му Дань или Шоу Мэй), спрессованный в блин для длительного хранения." },
          { id: "as_p_2", title: "Зелёный прессованный", content: "Зеленый чай в прессованном виде." },
          { id: "as_p_3", title: "Улун прессованный", content: "Прессованный улун (встречается реже, часто это старые или выдержанные улуны)." },
          { id: "as_p_4", title: "Красный прессованный", content: "Красный чай в форме блина или кирпича." },
          { id: "as_p_5", title: "Пуэр шу (прессованный)", content: "Классический темный пуэр в прессованном виде." },
          { id: "as_p_6", title: "Пуэр шэн (прессованный)", content: "Сырой пуэр, спрессованный для дальнейшей ферментации и старения." }
        ]
      },
      {
        id: "as_1_3", title: "1.3 Фасованный чай",
        children: [
          {
            id: "as_1_3_1", title: "По брендам (Бренд 1, Бренд 2 и т.д.)",
            children: [
              { id: "as_f_1", title: "Подарочная упаковка", content: "Чай в фирменных подарочных банках и шкатулках." },
              { id: "as_f_2", title: "Заварной (листовой фасованный)", content: "Классический листовой чай, фасованный производителем в пачки." },
              { id: "as_f_3", title: "Порционный (пакетированный)", content: "Чай в пакетиках или пирамидках для быстрого разового заваривания." }
            ]
          }
        ]
      }
  ...
  {
    id: "as_2", title: "2. КОФЕ",
    children: [
      {
        id: "as_2_1", title: "2.1 Весовой кофе (классификация по обжарщику/производителю)",
        children: [
          {
            id: "as_2_1_1", title: "По обжарщикам",
            children: [
              {
              ...
              {
                id: "as_2_1_1_2", title: "Ароматизированный",
                children: [
                  { id: "as_k_4", title: "Моносорта", content: "Ароматизированный кофе на базе одного сорта зерна (например, Ирландский крем на Бразилии)." },
                  { id: "as_k_5", title: "Купажи", content: "Ароматизированные смеси." }
                ]
              }
            ]
          }
      ...
      {
        id: "as_2_2", title: "2.2 Фасованный кофе",
        children: [
          {
            id: "as_2_2_1", title: "По брендам (Бренд 1, Бренд 2 и т.д.)",
            children: [
              { id: "as_f_k_1", title: "Подарочная упаковка", content: "Кофе в подарочных тубах и наборах." },
              {
                id: "as_f_k_2", title: "Зерновой",
                children: [
                  { id: "fk_1", title: "Моносорта", content: "Зерновой кофе моносорт в заводской фасовке." },
                  { id: "fk_2", title: "Эспрессо-смеси", content: "Зерновые эспрессо-смеси в пачках." },
                  { id: "fk_3", title: "Купажи", content: "Заводские купажи зернового кофе." },
                  { id: "fk_4", title: "Ароматизированный", content: "Ароматизированный зерновой кофе в пачках." }
                ]
              },
              {
                id: "as_f_k_3", title: "Молотый",
                children: [
                  { id: "fm_1", title: "Моносорта", content: "Фасованный молотый кофе одного сорта." },
                  { id: "fm_2", title: "Эспрессо-смеси", content: "Молотые эспрессо-смеси." },
              ...
              {
                id: "as_f_k_4", title: "Растворимый",
                children: [
                  { id: "fr_1", title: "Порошок", content: "Порошковый растворимый кофе (спрей-драйд)." },
                  { id: "fr_2", title: "Гранула", content: "Гранулированный растворимый кофе (агломерированный)." },
                  { id: "fr_3", title: "Кристалл", content: "Сублимированный растворимый кофе (фриз-драйд) в кристаллах." }
                ]
              },
              {
                id: "as_f_k_5", title: "Порционный",
                children: [
                  { id: "fp_1", title: "Чалды (дрип-пакеты)", content: "Дрип-пакеты для быстрого заваривания молотого кофе в чашке." },
                  { id: "fp_2", title: "Капсулы", content: "Кофейные капсулы для кофемашин (Nespresso, Dolce Gusto и др.)." },
                  { id: "fp_3", title: "Пакетики", content: "Индивидуальные пакетики." },
                  { id: "fp_4", title: "3 в 1", content: "Кофейные смеси формата «кофе + сахар + сливки»." }
                ]
              }
            ]
          }
  ...
  {
    id: "as_3", title: "3. ЧАЕПОДОБНЫЕ НАПИТКИ", desc: "Высушенные растения, не являющиеся Camellia sinensis: матэ, ройбос, иван-чай, кудин, лапачо, ханибуш, каркадэ, ромашка, чабрец, тибетские травы и т.д.",
    children: [
      {
        id: "as_3_1", title: "3.1 Весовые чаеподобные напитки",
        children: [
          {
            id: "as_3_1_1", title: "Этнические",
            children: [
              { id: "et_1", title: "Иван-чай", content: "Исконно русский напиток из листьев кипрея узколистного. Не содержит кофеина." },
              { id: "et_2", title: "Матэ", content: "Парагвайский чай из листьев падуба. Бодрящий напиток, традиционно пьется из калебаса." },
              { id: "et_3", title: "Ройбуш (ройбос)", content: "Африканский травяной напиток из кустарника. Сладковатый вкус, без кофеина." },
              { id: "et_4", title: "Прочие: кудин, лапачо, ханибуш, каркадэ", content: "Напитки со всего света с уникальными свойствами и вкусами." }
            ]
          },
          {
            id: "as_3_1_2", title: "Травяные",
            children: [
              { id: "tr_1", title: "Натуральные (марокканская мята, чабрец и др.)", content: "Марокканская мята, чабрец, ромашка и другие чистые травы." },
              { id: "tr_2", title: "Ароматизированные (типа «Силуэт»)", content: "Травяные сборы с добавлением ароматизаторов (например, для SPA или похудения, типа «Силуэт»)." }
            ]
          },
          { id: "as_3_1_3", title: "Фруктовые (типа \"Наглый фрукт\" и подобные)", content: "Смеси на основе гибискуса (каркаде) с кусочками фруктов и ягод." },
          {
            id: "as_3_1_4", title: "Растительные добавки к чаю",
            children: [
              { id: "rd_1", title: "Цветы хризантемы", content: "Добавка с мягким цветочным ароматом, отлично сочетается с пуэрами." },
              { id: "rd_2", title: "Бутоны роз", content: "Французская или китайская роза, придающая сладкий аромат купажу." },
              { id: "rd_3", title: "Лепестки василька", content: "Для украшения купажей и легкой цветочной нотки." },
              { id: "rd_4", title: "Цветы жасмина", content: "Используются как натуральный ароматизатор для зеленого чая." }
            ]
          },
          { id: "as_3_1_5", title: "Какао и цикорий", content: "Классический какао-порошок и напитки на основе корня цикория." }
        ]
      },
      { id: "as_3_2", title: "3.2 Фасованные чаеподобные напитки", content: "Аналогичная структура по категориям, с делением по брендам (фито-чаи, пакетированные травы и т.д.)." }
    ]
  },
  {
    id: "as_4", title: "4. СЛАДОСТИ И ДЕСЕРТЫ К ЧАЮ И КОФЕ", desc: "Съедобные без дополнительной обработки продукты, без особых условий хранения.",
    children: [
      {
        id: "as_4_1", title: "4.1 Длительного хранения (≥8 месяцев)",
        children: [
          {
            id: "as_4_1_1", title: "Сахар",
            children: [
              { id: "sh_1", title: "Тростниковый", content: "Коричневый тростниковый кусковой сахар." },
              { id: "sh_2", title: "Карамельный (леденцовый)", content: "Крупные кристаллы леденцового сахара на деревянных палочках для размешивания." }
            ]
          },
          { id: "as_4_1_2", title: "Мёд", content: "Различные сорта натурального меда (гречишный, липовый, цветочный)." },
          { id: "as_4_1_3", title: "Сиропы", content: "Сладкие сиропы для добавления в кофе (ваниль, карамель, орех)." },
          { id: "as_4_1_4", title: "Варенье, конфитюр, джемы", content: "Фруктовые и ягодные десерты в стеклянных баночках." }
        ]
      },
      {
        id: "as_4_2", title: "4.2 Скоропортящиеся (<8 месяцев)",
        children: [
          { id: "sp_1", title: "Выпечка", content: "Имбирные пряники, печенье и другие мучные изделия." },
          { id: "sp_2", title: "Нуга", content: "Сладкая нуга с добавлением орехов и цукатов." },
          { id: "sp_3", title: "Шоколадные изделия", content: "Шоколад, конфеты, драже." },
          { id: "sp_4", title: "Марципан", content: "Миндальная паста в виде фигурок или батончиков." }
        ]
      }
    ]
  },
  {
    id: "as_5", title: "5. ПОСУДА И АКСЕССУАРЫ",
    children: [
      {
        id: "as_5_1", title: "5.1 Для чая (по материалам)", desc: "Каждая группа по материалу включает: сервизы и наборы, чайники, гайвани, сливник (Ча Хай), пиалы, чашки и кружки, чайницы.",
        children: [
          ...
          {
            id: "as_5_1_7", title: "Принадлежности для чайной церемонии",
            children: [
              { id: "pr_1", title: "Ча Бань", content: "Чайная доска с поддоном для слива воды." },
              { id: "pr_2", title: "Ча Хэ", content: "Чайная коробочка для знакомства с сухим чайным листом." },
              { id: "pr_3", title: "Ча Цзюй", content: "Набор чайных инструментов (щипцы, игла, кисточка, лопатка)." },
              { id: "pr_4", title: "Пин Мин Бэй и Вэн Сян Бэй", content: "Чайные пары для дегустации: чаша для вкуса и высокая чаша для аромата." },
              { id: "pr_5", title: "Прочие", content: "Чайные фигурки (писающие мальчики, жабы), полотенца." }
            ]
          },
          {
            id: "as_5_1_8", title: "Аксессуары для чая",
            children: [
              { id: "ak_1", title: "Банки для хранения", content: "Жестяные, стеклянные или керамические емкости с плотной крышкой." },
              { id: "ak_2", title: "Ситечки", content: "Металлические или бамбуковые ситечки для фильтрации настоя." },
              { id: "ak_3", title: "Ножи и шила для пуэра", content: "Инструмент для аккуратного расслаивания прессованного чая без повреждения листа." },
              { id: "ak_4", title: "Прочие", content: "Мерные ложки, термометры." }
            ]
          }
        ]
      },
      {
        id: "as_5_2", title: "5.2 Для кофе",
        children: [
          ...
          { id: "cf_4", title: "Френч-прессы", content: "Колбы с поршнем-фильтром для заваривания кофе (и чая)." },
          {
            ...
            children: [
              { id: "cp_1", title: "Эспрессо (50–70 мл)", content: "Толстостенные маленькие чашки для сохранения крема и температуры." },
              { id: "cp_2", title: "Чёрный кофе (80–100 мл)", content: "Чашки среднего объема." },
              { id: "cp_3", title: "Американо (>100 мл)", content: "Большие кружки." }
            ]
          },
          { id: "cf_6", title: "Прочие", content: "Темперы, питчеры, весы." }
        ]
      },
      {
        id: "as_5_3", title: "5.3 Для матэ",
        children: [
          { id: "mt_1", title: "Калебасы", content: "Традиционные сосуды из тыквы-горлянки (или керамики/дерева) для заваривания матэ." },
          { id: "mt_2", title: "Бомбильи", content: "Металлические трубочки с ситечком на конце для питья матэ." },
          { id: "mt_3", title: "Термосы", content: "Специальные термосы с узким носиком для удобного подливания воды в калебас." }
        ]
      }
    ]
  },
  {
    id: "as_6", title: "6. ПОДАРОЧНАЯ УПАКОВКА", desc: "Продаётся отдельно за плату (не бесплатные материалы).",
    children: [
      { id: "pu_1", title: "Пакеты и сумки", content: "Плотный полиэтилен с тематическим дизайном (например, новогодние)." },
      { id: "pu_2", title: "Коробки и корзины", content: "Подарочные ящички, шкатулки, сундучки и плетеные корзины для сборки наборов." },
      {
        id: "pu_3", title: "Упаковка для прессованного чая",
        children: [
          { id: "pup_1", title: "Картонные и жестяные коробки", content: "Жесткая упаковка для пуэрных блинов." },
          { id: "pup_2", title: "Пакеты/сумки для бин ча (блинов)", content: "Специализированные чехлы круглой формы." },
          { id: "pup_3", title: "Пакеты/сумки для чжуан ча (кирпичей)", content: "Упаковка под формат кирпича." }
        ]
      }
    ]
  },
  {
    id: "as_7", title: "7. СОПУТСТВУЮЩИЕ ТОВАРЫ", desc: "То, что дополняет ассортимент без нарушения чайно-кофейной концепции магазина.",
    children: [
      { id: "st_1", title: "Сувениры фэн-шуй", content: "Писающие мальчики, фигурки меняющие цвет при контакте с горячей водой, жабы, драконы, черепахи, хотеи и т.д." },
      { id: "st_2", title: "Книги на чайную тематику", content: "Похлёбкин, Вингородский, «Чайный канон» Лю Юя, труды по буддизму, японская поэзия и др." },
      { id: "st_3", title: "Аромамасла и аксессуары", content: "Аромалампы (5–7 шт.), эфирные масла (20–30 наименований)." },
      { id: "st_4", title: "Го (вейчи, бадук)", content: "Классическая китайская настольная стратегическая игра." }
    ]
  }
];
  ...
  return (
    <div style={{ backgroundColor: '#0d0f0d', minHeight: '100vh', color: '#fff', display: 'flex', transition: '0.3s', overflowX: 'hidden' }}>
      ...
      <main className="tasks-main" style={{ flex: 1, padding: '120px 60px 60px 60px', transition: '0.3s', maxWidth: '100%', overflowX: 'hidden', boxSizing: 'border-box' }}>
                     ...
                     {dynamicRoute.map((step, idx) => {
                        ...
                        return (
                           <div key={step.id} onClick={() => setSelectedRouteStep(step)} className="premium-card">
                              ...
                              <span style={{fontSize:'12px', color:'#0abab5', fontWeight:'800', marginBottom: '6px'}}>Тема 0{idx+1}</span>
        ...
        {showRouteForm && (
            <div style={modalOverlay}>
                <div className="tasks-modal" style={{...modalContent, maxWidth: '600px'}}>
                    ...
                    <button onClick={handleSaveRoute} style={{...saveBtn, marginTop: '25px'}}>СОХРАНИТЬ ТЕМУ</button>
           ...
           <div style={modalOverlay}>
              <div className="tasks-modal" style={modalContent}>
                 ...
                 <div style={{animation: 'fadeInUp 0.3s ease'}}>
                     ...
                     <button onClick={() => handleRouteComplete(selectedRouteStep.id)} style={checkKnowledgeBtn}>Я ИЗУЧИЛ ЭТУ ТЕМУ</button>
                 </div>
              </div>
           </div>
        )}
