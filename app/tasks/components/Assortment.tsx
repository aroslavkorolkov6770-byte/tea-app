...
// --- КОМПОНЕНТ РЕКУРСИВНОГО УЗЛА АССОРТИМЕНТА ---
export function AssortmentNode({ node, depth = 0, targetId }: { node: any, depth?: number, targetId?: string | null }) {
        ...
        <div style={{ 
            ...
            <div 
                ...
                style={{
                    ...
                    borderRadius: '10px', 
                    cursor: 'pointer', 
                    // Яркая подсветка найденного элемента
...
// --- ГЛАВНЫЙ КОМПОНЕНТ АССОРТИМЕНТА ---
export default function Assortment({ assortmentMatrix, assortmentId }: { assortmentMatrix: any[], assortmentId: string | null }) {
    // Если по какой-то причине с сервера пришел пустой массив, используем INITIAL_ASSORTMENT
